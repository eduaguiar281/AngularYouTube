...
namespace AngularSPA
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<DataSettings>(s =>
            {
                s.ConnectionString = Configuration.GetSection("MongoDB:ConnectionString").Value;
                s.DatabaseName = Configuration.GetSection("MongoDB:DatabaseName").Value;
